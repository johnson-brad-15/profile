  ...
  >
    <div className='bioContainer' style={{display: 'flex', flexDirection: 'row', backgroundColor: 'transparent', color: 'white'}}>
      ...
      <div className="bioVeriage">
        ...
        {/* <Heading as='h2'>Brad Johnson <span className='bioRole'> | Sr. Software Engineer | Quantitative Developer</span></Heading>
        <div className='bioTitle'>
          Brad Johnson <span className='bioRole'> | Sr. Software Engineer | Quantitative Developer</span>
        </div> */}
        {`I am a full stack developer with over 25 years of experience. I have experience writing low-latency 
